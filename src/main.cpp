...
#if defined(NDEBUG)
# error "Potatocoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x2af343186950017ec619a1c768e4d2a5ff1a1ade47314071aaee7ff5f3f0ab6a");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 10000); // Potatocoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Potatocoin: 1 days
static const int64 nTargetSpacing = 6 * 60; // Potatocoin: 6 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xfeaf1cc85717a2f00c3700a2d7209e2e96a608b4b131795bc042430319a65838");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Pfizer says antiviral pill 89 percent effective in high risk cases";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04f649312fdea0773077940300527a9a1844cc5b7d14589cc305fffc37dd5d6e97cacfd195d3e31d1f80f0b720dfe305f0abc0fe310eeb225620e8a2cf762be8be") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1636122316;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084631377;

        if (fTestNet)
        {
            block.nTime    = 1636122275;
            block.nNonce   = 385437217;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x8fa755c30d09f5b2b56093bac80ed7ec562acf981bcf9360ebfd0905a84c6255"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc1, 0xb2, 0xd1 }; // Potatocoin: increase each by adding 2 to bitcoin's value.
